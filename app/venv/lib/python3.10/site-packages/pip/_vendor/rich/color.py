...
class Color(NamedTuple):
    ...
    def parse(cls, color: str) -> "Color":
        ...
        if color_24:
            triplet = ColorTriplet(int(color_24[0:2], 16), int(
            ...
            return cls(color, type=(ColorType.STANDARD if number <
                                    16 else ColorType.EIGHT_BIT), number=number, )
...
def parse_rgb_hex(hex_color: str) -> ColorTriplet:
    ...
    color = ColorTriplet(int(hex_color[0:2], 16), int(
