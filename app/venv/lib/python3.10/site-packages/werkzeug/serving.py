                ...
                if e.errno == errno.EADDRINUSE:
                    ...
                    if sys.platform == "darwin" and port == 5000:
                        print(
                            ...
                            " from System Preferences -> General -> AirDrop & Handoff.", file=sys.stderr, )
    ...
    def log_startup(self) -> None:
        ...
        if self.address_family == af_unix:
            ...
            if self.host in {"0.0.0.0", "::"}:
                ...
                messages.append(
                    f" * Running on {scheme}://{localhost}:{self.port}")
...
def make_server(
    ...
    if threaded and processes > 1:
        raise ValueError(
            "Cannot have a multi-thread and multi-process server.")
