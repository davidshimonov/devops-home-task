...
class Headers:
    ...
    def __getitem__(self, key: str | int |
                    slice) -> str | tuple[str, str] | te.Self:
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return set(map(lowered, other._list)) == set(
            map(lowered, self._list))  # type: ignore[attr-defined]
    ...
    @t.overload
    def get(self, key: str, default: T,
            type: cabc.Callable[[str], T]) -> T: ...
    ...
    def setlistdefault(self, key: str,
                       default: cabc.Iterable[t.Any]) -> list[str]:
    ...
    def __setitem__(
        ...
        if isinstance(key, str):
            ...
            self._list[key] = value[0], _str_header_value(
                value[1])  # type: ignore[index]
        else:
            self._list[key] = [(k, _str_header_value(v))
